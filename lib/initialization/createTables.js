...
var createTableSQL6 = 'CREATE TABLE ' + tableNames.PAYMENT_METHOD_TABLE +
    ' (userId INT PRIMARY KEY,' + //we only allow one payment for one user at this time
    ' stripeCustomerId VARCHAR(50), ' +
    ' funding VARCHAR(32), ' + //credit or debit
    ' type VARCHAR(50), ' + // visa or master or discover
    ' cvc VARCHAR(50), ' +
    ' address VARCHAR(50), ' +
    ' phone  VARCHAR(50), ' +
