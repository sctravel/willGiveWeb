...
var dropTableSQL4='DROP TABLE '+ tableNames.RECEIPIENT_TABLE;
...
var createTableSQL3 = 'CREATE TABLE ' + tableNames.USER_SETTING_TABLE  +
    ...
    ' max_amount_per_pay INT default 300, ' +
    ' max_amount_per_day INT default 100, ' +
...
var createTableSQL4 = 'CREATE TABLE ' + tableNames.RECEIPIENT_TABLE +
    ' (receipient_id INT PRIMARY KEY AUTO_INCREMENT, ' +
    ...
    ' last_updated_by VARCHAR(15) default \'sysuser\', ' +
    ' last_updated_time TIMESTAMP  DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ' +
    ' UNIQUE(receipient_id) ' +  //LOGIN and PASSWORD?
...
var createTableSQL5 = 'CREATE TABLE ' + tableNames.TRANSACTION_TABLE +
    ...
    ' FOREIGN KEY receipient_id (receipient_id) REFERENCES '+tableNames.RECEIPIENT_TABLE+' (receipient_id) ON DELETE RESTRICT ' +
    ' )ENGINE=InnoDB AUTO_INCREMENT=900000001 DEFAULT CHARSET=utf8 ';
