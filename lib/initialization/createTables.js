...
var dropTableSQL4='DROP TABLE '+ tableNames.RECEIPT_TABLE;
...
var createTableSQL4 = 'CREATE TABLE ' + tableNames.RECEIPT_TABLE +
    ...
    ' last_updated_by VARCHAR(15) default \'sysuser\', ' +
    ' last_updated_time TIMESTAMP  DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ' +
    ' UNIQUE(receipt_id) ' +  //LOGIN and PASSWORD?
