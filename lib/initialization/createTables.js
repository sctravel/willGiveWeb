...
var createTableSQL4 = 'CREATE TABLE ' + tableNames.RECIPIENT_TABLE +
    ...
    ' Email VARCHAR(63), ' +
    ' password VARCHAR(63), ' +
    ' CONTACT_PERSON_NAME VARCHAR(63),' +
    ' CONTACT_PERSON_Title VARCHAR(63), ' +
    ' MISSION BLOB , ' +
...
var createTableSQL8 = ' CREATE TABLE ' + tableNames.USER_CONTACT_US +
    ' ( id INT PRIMARY KEY AUTO_INCREMENT, user_id INT, email VARCHAR(255), name VARCHAR(63),' +
    ' CONTENT BLOB, datetime TIMESTAMP default now() )ENGINE=InnoDB DEFAULT CHARSET=utf8';

var createTableSQL9 = ' CREATE TABLE ' + tableNames.HOT_CHARITIES +  ' ( recipient_id INT PRIMARY KEY AUTO_INCREMENT )';
/////////////////////////////////////////////////////////////////////
