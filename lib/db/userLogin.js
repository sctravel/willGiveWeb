...
exports.getUserTransactionHistory = function(userId, callback) {
    var sql = 'select ut.transaction_id as transactionId, ut.amount, ut.recipient_id as recipientId, r.name, r.image_url as imageUrl, ' +
        ' r.video_url as videoUrl, date_format(ut.datetime, \'%Y-%m-%d %H:%i:%s\') as dateTime, ut.settletime as settleTime, ut.status, ut.confirmationCode from ' + tableNames.TRANSACTION_TABLE +
