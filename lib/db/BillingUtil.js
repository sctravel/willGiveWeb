...
exports.updateTransactionHistroy= updateTransactionHistroy;
    ...
    var sql = 'select pm.stripeCustomerId, ut.amount, ut.notes, ut.recipientId from payment_method pm right join user_transactions ut on pm.userId= ut.userId where ut.confirmationCode=? ';
